...
There are also some issues here. Firstly, registration map is in .xlsx, and requires additional processing to get desired format. Secondly, the locartion details in the cahrging station dataset are subject to change. It's better to call the stations to verify a station's information, such asopen time, hours of operation, availablility to the public, and if has the desired alternative fuel prior to making a trip to that location.
